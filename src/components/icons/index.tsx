...
/**
 * Icon components — SVG icons used throughout the app.
 * Consistent 24x24 viewBox, currentColor stroke, configurable size.
 */
...
function defaultProps(size: number = 20): Partial<IconProps> {
  return {
    width: size,
    height: size,
    viewBox: "0 0 24 24",
...
export function IconEvent({ size, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
...
export function IconBell({ size, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
...
export function IconTrendUp({ size, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
...
export function IconTrendDown({ size, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
...
export function IconDollar({ size, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
...
export function IconExpand({ size, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
...
export function IconLink({ size, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
      <path d="M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m9.914 0a4.5 4.5 0 00-1.242-7.244l-4.5-4.5a4.5 4.5 0 00-6.364 6.364L4.75 8.688" />
    </svg>
  );
}
...
export function IconKanban({ size, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
      <path d="M9 4.5v15m6-15v15m-10.875 0h15.75c.621 0 1.125-.504 1.125-1.125V5.625c0-.621-.504-1.125-1.125-1.125H4.125c-.621 0-1.125.504-1.125 1.125v12.75c0 .621.504 1.125 1.125 1.125z" />
    </svg>
  );
}
...
export function IconBriefcase({ size, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
...
export function IconTiktok({ size, ...props }: IconProps) {
  return (
    <svg
      {...defaultProps(size)}
      {...props}
      ...
      viewBox="0 0 24 24"
    >
      <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.2a6.34 6.34 0 0010.86 4.46V13.2a8.16 8.16 0 005.58 2.2V12a4.85 4.85 0 01-3.58-1.57V6.69h3.58z" />
    </svg>
  );
}

export function IconFacebook({ size, ...props }: IconProps) {
  return (
    <svg
      {...defaultProps(size)}
      {...props}
...
export function IconLinkedin({ size, ...props }: IconProps) {
  return (
    <svg
      {...defaultProps(size)}
      {...props}
...
export function IconGoogleCalendar({ size, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
      <path d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
...
/** Wallet / Finance icon (banknotes) */
export function IconWallet({ size, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
      <path d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z" />
    </svg>
...
export function IconArrowDownLeft({ size, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
...
/** Chart-bar icon (reports) */
export function IconChartBar({ size, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
...
export function IconPaperclip({ size, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
...
export function IconReceipt({ size, ...props }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size ?? 20} height={size ?? 20} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M14 8h-5"></path>
      <path d="M14 12h-5"></path>
    </svg>
  );
}

export function IconCash({ size, ...props }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size ?? 20} height={size ?? 20} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function IconTag({ size, ...props }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size ?? 20} height={size ?? 20} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function IconPhoto({ size, ...props }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size ?? 20} height={size ?? 20} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
