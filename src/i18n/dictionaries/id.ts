...
const id: Dictionary = {
  ...
  booking: {
    ...
    completeDataSubtitle: "Silakan lengkapi data Anda untuk melanjutkan.",
    completeDataButton: "Simpan & Lanjutkan",
    submitSuccess: "Berhasil dikirim!",
    phoneSecondary: "Telepon Kedua (opsional)",
    phoneSecondaryPlaceholder: "Masukkan nomor telepon kedua",
    eventLocationUrl: "Link Google Maps",
    eventLocationUrlPlaceholder: "Tempel link share Google Maps di sini",
  },
  ...
  settings: {
    ...
    // Event Categories
    eventCategoriesTitle: "Kategori Acara",
    eventCategoriesSubtitle:
      "Tentukan jenis acara yang dapat dipilih klien Anda.",
    addEventCategory: "Tambah Kategori Acara",
    editEventCategory: "Edit Kategori Acara",
    eventCategoryName: "Nama Kategori Acara",
    eventCategoryNamePlaceholder: "mis. Pernikahan",
    eventCategoryDescription: "Deskripsi",
    eventCategoryDescPlaceholder: "Deskripsi singkat jenis acara ini",
    noEventCategories: "Belum ada kategori acara",
    noEventCategoriesDesc:
      "Buat kategori acara agar klien dapat memilih jenis acara mereka.",
    confirmDeleteEventCategory: "Hapus kategori acara ini?",
    active: "Aktif",
    archived: "Nonaktif",
  },
  ...
  finance: {
    title: "Keuangan",
    subtitle: "Kelola pembukuan — paket, transaksi, dan laporan.",

    // Tabs
    tabPackages: "Paket & Add-on",
    ...
    accountNamePlaceholder: "cth. Bank Utama, Kas, Kas Kecil",
    accountDescription: "Deskripsi (opsional)",
    accountDescPlaceholder: "Deskripsi singkat akun ini",
    noAccounts: "Belum ada akun",
    noAccountsDesc: "Buat akun pertama Anda untuk mulai mencatat keuangan.",
    confirmDeleteAccount: "Hapus akun ini?",
    ...
    noTransactionsDesc: "Catat pemasukan atau pengeluaran pertama Anda.",
    income: "Pemasukan",
    expense: "Pengeluaran",
    amount: "Jumlah",
    category: "Kategori",
    categoryPlaceholder: "cth. Venue, Peralatan, Transport",
    ...
    notes: "Catatan (opsional)",
    notesPlaceholder: "Catatan tambahan...",
    receipt: "Struk (opsional)",
    linkedEvent: "Event Terkait (opsional)",
    tags: "Tag",
    tagsPlaceholder: "cth. pajak, reimbursement",
    confirmDeleteTransaction: "Hapus transaksi ini?",
    allTypes: "Semua Tipe",
    ...
    reportsSubtitle: "Ringkasan laba rugi untuk periode yang dipilih.",
    ...
    noReportData: "Tidak ada data untuk periode yang dipilih.",
    noReportDataDesc: "Catat transaksi untuk melihat laporan laba rugi Anda.",
  },
};
